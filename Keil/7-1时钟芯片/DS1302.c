...
unsigned char Command[] = {DS1302_SECONDS_WADDR, DS1302_MINUTES_WADDR, DS1302_HOUR_WADDR, DS1302_DATE_WADDR, DS1302_MONTH_WADDR, DS1302_DAY_WADDR, DS1302_YEAR_WADDR};
...
void DS1302_Init()
{
	...
	for (sec = 0; sec < sizeof(Command); ++sec) {
		DS1302_WriteByte(Command[sec], DecToBcd(SetTime[sec]));
	}
